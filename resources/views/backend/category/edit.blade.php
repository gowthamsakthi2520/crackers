            ...
            <div class="card-body">
                <form class="row g-3" action="{{route('category.update',$category->id)}}" method="POST">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control" name="name" id="inputName" placeholder="Category Name" value="{{$category->name}}">
                        @error('name')<span class="text-danger">{{$message}}</span>@enderror
                    </div>

                    <div class="col-md-12">
                        <label for="inputName" class="form-label">Description</label>
                        <textarea class="desc-text" name="description" id="editor">{{$category->description}}</textarea>
