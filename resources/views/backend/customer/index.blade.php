          ...
          <div class="card-body">
            <div class="customer-table">
              <div class="table-responsive white-space-nowrap">
                 <table id="customer" class="table table-bordered align-middle" style="width:100%">
                   ...
                   <tbody>
                     <!-- <tr>
                      <td>1</td>
                       ...
                       <td>
                        <a href="ecommerce-customer-details.php"><button class="btn btn-sm btn-light border" type="button"><i class="bi bi-eye-fill text-primary"></i></button></a>
                        <a><button class="btn btn-sm btn-light border" type="button"><i class="bi bi-trash3-fill text-danger"></i></button></a>
                       </td>
                     </tr>
...
var reporttables =  $('#customer').DataTable({
  "order": [[ 0, "desc" ]],
      "serverSide": true,
  "stateSave": true,
      'processing': true,
  ...
  },
  {
    ...
    "render": function ( data, type, row, meta ) {
      return '<a href="ecommerce-order-details.php">'+row.full_name+'</a>';
    }
  },
  {
    "targets": 2,
    orderable: false,
    "render": function ( data, type, row, meta ) {
     return'<a class="d-flex align-items-center gap-3" href="ecommerce-order-details.php"><div class="customer-pic"><img </div><p class="mb-0 customer-name fw-bold">'+row.email+'</p></a>';
    ...
    },
  {
    ...
    orderable: false,
    "render": function ( data, type, row, meta ) {
      return'<span class="lable-table bg-warning-subtle text-warning rounded border border-warning-subtle font-text2 fw-bold">'+row.order_id+' <i class="bi bi-clock-history"></i></span>';
  ...
  },
  {
    ...
    "render": function ( data, type, row, meta ) {
      ...
      return '<a href="{{route('customer.show','')}}/'+row.id+'"><button class="btn btn-sm btn-light border" type="button"><i class="bi bi-eye-fill text-primary"></i></button></a><a><button class="btn btn-sm btn-light border"  onclick="deleteOrder('+row.id+')" type="button"><i class="bi bi-trash3-fill text-danger"></i></button></a>';
    ...
    $.ajax({
      ...
      success: function (res) {
        if (res) {
          ...
          swal("order Delete Failed", "Please try again. :)", "error");
        }
      }
    });
