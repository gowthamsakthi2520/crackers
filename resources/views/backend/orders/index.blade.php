 ...
 <main class="page-content">
    ...
    <div class="col-auto pb-4">
      <!-- <div class="d-flex align-items-center gap-2 justify-content-lg-end">
        <a href="ecommerce-add-product.php"><button class="btn btn-primary px-4"><i class="bi bi-plus-lg me-2"></i>Add
            Order</button></a>
      </div> -->
    </div>
    </div><!--end row-->
      ...
      <div class="card-body">
        <div class="customer-table">
          <div class="table-responsive white-space-nowrap">
            <table id="orderList" class="table table-bordered align-middle" style="width:100%">
...
var reporttables =  $('#orderList').DataTable({
  "order": [[ 0, "desc" ]],
      "serverSide": true,
  "stateSave": true,
      'processing': true,
  ...
  },
  {
    ...
    "render": function ( data, type, row, meta ) {
      return '<a href="{{route('orders.show','')}}/'+row.id+'">'+row.order_id+'</a>';
    }
  },
  {
    "targets": 2,
    orderable: false,
    "render": function ( data, type, row, meta ) {
     return'<a class="d-flex align-items-center gap-3" href="ecommerce-order-details.php"><div class="customer-pic"><img </div><p class="mb-0 customer-name fw-bold">'+row.full_name+'</p></a>';
  ...
  },
  {
    ...
    orderable: false,
    "render": function ( data, type, row, meta ) {
     return'<span class="lable-table bg-warning-subtle text-warning rounded border border-warning-subtle font-text2 fw-bold">'+row.payment_status+' <i class="bi bi-clock-history"></i></span>';
  ...
  },
  {
    ...
    "render": function ( data, type, row, meta ) {
      ...
      return '<a href="{{route('orders.show','')}}/'+row.id+'"><button class="btn btn-sm btn-light border" type="button"><i class="bi bi-eye-fill text-primary"></i></button></a><a><button class="btn btn-sm btn-light border"  onclick="deleteOrder('+row.id+')" type="button"><i class="bi bi-trash3-fill text-danger"></i></button></a>';
